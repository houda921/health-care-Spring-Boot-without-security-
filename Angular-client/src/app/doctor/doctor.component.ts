...
export class DoctorComponent implements OnInit {
  ...
  id;
  constructor(private router: Router, private ds: DoctorService, private route: ActivatedRoute, private spSer: SpecializationService, private deptSer: DepartmentService,
